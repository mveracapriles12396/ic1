...
public class CardTrick {
    ...
    private static void printInfo() {
        ...
        System.out.println("I’m done! Congratulations, you guessed right!");
        System.out.println();
        
        System.out.println("My name is Moises Vera, but you can call me moises");
        System.out.println();
        
        System.out.println("My career ambitions: finish my college");
        System.out.println(" Be more active on LinkedIn");
        System.out.println("2 Have a semester with no violations of academic integrity!");
	System.out.println();	
